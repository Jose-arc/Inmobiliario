CREATE DATABASE IF NOT EXISTS bt_inmobiliario CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE IF NOT EXISTS oferente (
    ...
    idtipo int NULL,
    idoferente varchar(255) NULL,
    image_oferente varchar(255) NULL
...
CREATE TABLE IF NOT EXISTS `propiedades` (
    ...
    calleandnumber varchar(255) NULL,
    idformato int NULL,
    uf varchar(255) NULL,
    monedalocal varchar(255) NULL,
    mt2totales varchar(255) NULL,
...
BEGIN
    SELECT * 
     ...
     INNER JOIN tipo t 
     ON n.categoria = t.Id
    WHERE n.categoria = id;
END //
 
DELIMITER ;

CALL get_categoria_noticia(0);

------------------------------------
DELIMITER //

CREATE PROCEDURE get_categoria_oferente(
    IN id INT(11)
)
BEGIN
    SELECT * 
...
CALL get_categoria_oferente(0);

----------------------------------------------------
DELIMITER //

CREATE PROCEDURE get_detalle_oferente(
    IN id INT(11)
)
BEGIN
    SELECT *
...
CALL get_detalle_oferente(0);

--------------------------------------------------
DELIMITER //

CREATE PROCEDURE delete_oferente(
    IN id INT(11)
)
BEGIN
    DELETE
