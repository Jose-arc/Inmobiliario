...
-- Tiempo de generación: 12-12-2019 a las 20:16:34
...
--
-- Base de datos: `bt_inmobiliario`
--
CREATE DATABASE IF NOT EXISTS `bt_inmobiliario` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bt_inmobiliario`;
...
(1, 'image-1574970460-Hullk.jpg'),
(2, 'image-1574974031-Guardianes-de-la-galaxia.jpg'),
(3, 'image-1575034673-dios.jpg'),
(4, 'image-1575034811-trigger-formulario.jpg'),
(5, 'image-1575405931-pic2.jpg'),
(6, 'image-1575492114-burgos.jpg'),
(7, 'image-1575575872-noticia1.jpg');
...
INSERT INTO `entrega` (`Id`, `Nombre`) VALUES
(0, 'Verde'),
(1, 'Blanco'),
(2, 'Proyecto'),
(3, 'Inmediata');
...
(1, 'ignacio@mymarketlogic.cl', '123456', '0b380c06d9bf5ac62f8fbded2c4409493a5212c2');
...
CREATE TABLE IF NOT EXISTS `noticias` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idnoticias` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `titulo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `imagen` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `body` varchar(9999) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fecha` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `by` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fullfecha` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `noticias` (`id`, `idnoticias`, `titulo`, `imagen`, `body`, `fecha`, `by`, `fullfecha`, `categoria`) VALUES
(34, 'news-rfsshel', 'Banco Central: Si el desempleo llega al 10 por ciento y la inflaciÃ³n al 6%, retrocederemos 27 aÃ±os', 'image-1575575872-noticia1.jpg', 'Al entregar el Informe de PolÃ­tica Monetaria (IPoM) ante la comisiÃ³n de Hacienda del Senado, el presidente del Banco Central, Mario Marcel, llamÃ³ a la alerta al anunciar que \"si el desempleo se estaciona en cifras en torno al 10 por ciento y la inflaciÃ³n se empinara al seis por ciento\", Chile retrocederÃ¡ 27 aÃ±os en el combate contra la desigualdad.\n\nEl Ã³rgano emisor realizÃ³ un fuerte recorte en la proyecciÃ³n de crecimiento para el paÃ­s, al proyectar una tasa de un 1,0 por ciento para este aÃ±o, bajando desde el rango de 2,25 a 2,75 de septiembre Ãºltimo, mientras que para 2020 estimÃ³ que la economÃ­a crecerÃ¡ apenas entre un 0,5 y un 1,5 por ciento.\n\nAnte el senado, Marcel precisÃ³ que \"las proyecciones de este IPoM hablan de caÃ­das de la actividad, grandes pÃ©rdidas econÃ³micas para algunos sectores, destrucciÃ³n de empleos y enormes desafÃ­os para la recuperaciÃ³n, especialmente si se quiere que esta ocurra sin mÃ¡s presiones sobre el costo de vida y bienestar de la ciudadanÃ­a\".\n\n\"Las autoridades y los chilenos en general tendremos que trabajar mucho para evitar las consecuencias mÃ¡s daÃ±inas y persistentes en el desempleo y la inflaciÃ³n, lo que sabemos tambiÃ©n incrementarÃ­a los niveles de desigualdad\", remarcÃ³.', '5-12-2019', 'Cooperativa.cl', 'Jueves, 5 de Diciembre de 2019, 5:9 PM', '0'),
(35, 'news-0wjrmm9', 'Intendencia invocarÃ¡ Ley de Seguridad del Estado por ataque que dejÃ³ dos carabineros baleados', 'image-1575492114-burgos.jpg', 'Graves incidentes afuera de la Tenencia Mauricio Rivera LÃ³pez, ubicada en la Avenida Cardenal RaÃºl Silva HenrÃ­quez, en la comuna de La Granja, terminÃ³ con un civil y tres funcionarios de Carabineros baleados, uno de ellos en estado grave. \n\nLos uniformados fueron trasladados en primera instancia hasta el Servicio de AtenciÃ³n Primaria de Urgencia de La Granja, para luego ser derivados vÃ­a aÃ©rea al Hospital Institucional, donde se mantienen internados. \n\nEl hecho ocurriÃ³ una vez finalizada la performance de la agrupaciÃ³n feminista \"LasTesis\", \"Un violador en tu camino\", afuera de la tenencia.\n\nDe acuerdo con la versiÃ³n de Carabineros, un grupo de personas externas a la manifestaciÃ³n lanzÃ³ piedras de gran tamaÃ±o contra el cuartel policial, lo que escalÃ³ hasta registrarse disparos en contra de la unidad. \n\nEl coronel Juan Narbona, de la Prefectura Sur, indicÃ³ pasadas las 01:00 de la madrugada que una vez terminada la performance \"comenzamos a recibir insultos y objetos contudentes. Luego, derechamente, nuestra unidad fue atacada con armamento de fuego de grueso calibre y rÃ¡fagas de municiÃ³n que llegaron a nuestros cuarteles\". ', '6-12-2019', 'Cooperativa.cl', 'Viernes, 6 de Diciembre de 2019, 2:16 PM', '1'),
(36, 'news-ql0ckcg', 'The IT Crowd', 'image-1574970460-Hullk.jpg', 'Un departamento de tecnologÃ­a de una empresa conformado por tres personas poco sociables estÃ¡n relegados al sÃ³tano, donde hacen de lo mejor por mantener las cosas funcionando y con un mÃ­nimo de contacto social.', '6-12-2019', 'Usuarios de Google', 'Viernes, 6 de Diciembre de 2019, 3:30 PM', '1');
...
CREATE TABLE IF NOT EXISTS `oferente` (
  ...
  `idoferente` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `image_oferente` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `oferente` (`id`, `nombre`, `rut`, `direccion`, `email`, `telefono`, `siteweb`, `idtipo`, `idoferente`, `image_oferente`) VALUES
(12, 'Bimtool', '10.232.232-1', 'avenida italia 850', 'Bimtool', '666', 'https://bimtool.com', 3, 'oferente-knmob4t', 'image-1574974031-Guardianes-de-la-galaxia.jpg,image-1574970460-Hullk.jpg'),
(13, 'Smartcaca', '199559494', 'avenida italia 834', 'ignacio@mymarketlogic.cl', '555', 'smartdici.cl', 2, 'oferente-4x1idk2', 'image-1574970460-Hullk.jpg');
...
CREATE TABLE IF NOT EXISTS `propiedades` (
  ...
  `CalleandNumber` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `MT2Totales` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `MT2Construidos` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `IdOferente` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Modelos` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `MapaUbicacion` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TipoProp` int(11) DEFAULT NULL,
  `Videos` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Galeria` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Equipamiento` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Bodega` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Dormitorios` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Baños` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Corredor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `IdEntrega` int(11) DEFAULT NULL,
  `Financiamiento` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Banco` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Dividendo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AñosPlazo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
CREATE TABLE IF NOT EXISTS `proyectos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `IdProyecto` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Nombre` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Imagen` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `tipopropiedad` (`Id`, `Nombre`) VALUES
(0, 'Casa'),
(1, 'Depto'),
(2, 'Oficina'),
(3, 'Parcela'),
...
--
-- Estructura Stand-in para la vista `vista_banco`
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vista_banco`;
CREATE TABLE IF NOT EXISTS `vista_banco` (
`Id` int(11)
,`Nombre` varchar(255)
);
...
--
-- Estructura Stand-in para la vista `vista_tipo`
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vista_tipo`;
CREATE TABLE IF NOT EXISTS `vista_tipo` (
`Id` int(11)
,`Nombre` varchar(255)
);
...
--
-- Estructura para la vista `vista_banco`
--
DROP TABLE IF EXISTS `vista_banco`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vista_banco`  AS  select `banco`.`Id` AS `Id`,`banco`.`Nombre` AS `Nombre` from `banco` order by `banco`.`Id` desc ;

-- --------------------------------------------------------

--
-- Estructura para la vista `vista_tipo`
--
DROP TABLE IF EXISTS `vista_tipo`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vista_tipo`  AS  select `tipo`.`Id` AS `Id`,`tipo`.`Nombre` AS `Nombre` from `tipo` ;
COMMIT;
